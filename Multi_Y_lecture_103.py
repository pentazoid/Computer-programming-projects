...
def graph_data(stock):
   ...
   candlestick_ohlc(ax2,new_list[-start:],width=.6,colorup='r',colordown='g')
   ax2.grid(True)    
   ...
   ax2.plot_date(date[-start:],volume[-start:],'-')
...
##
   ...
   ax2v.fill_between(date[-start:],0,volume[-start:], facecolor="#7900a3",alpha=0.4)
